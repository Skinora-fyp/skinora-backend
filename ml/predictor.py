...
from .model_loader import get_skin_type_model, get_skin_type_labels
...
def predict_skin_type(image_path: str) -> dict:
    ...
    Pipeline:
        ...
        2. Preprocessing    (resize 224×224, MobileNetV2 normalization)
        3. Model inference  (MobileNetV2 classifier)
        4. Result formatting
